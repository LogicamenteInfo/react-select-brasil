...
export default class UnidadesMedida extends CommonSelect {
  static options = [
    ...
    { value: 'BOMBEAR', label: 'Bombona' },
    { value: 'CÁPSULAS', label: 'Cápsula' },
    { value: 'CARRINHO', label: 'Cartela' },
