...
export default class Cidades extends CommonSelect {
  ...
  static options = {
    ...
    'TO': [
      ...
      { value: 'Couto de Magalhães', label: 'Couto de Magalhães' },
      ...
      { value: 'Santa Terezinha Tocantins', label: 'Santa Terezinha Tocantins' },
      ...
      { value: 'São Valério da Natividade', label: 'São Valério da Natividade' },
  ...
  state = {
    options: this.carregarCidades()
  }

  carregarCidades() {
    const noState = [{ value: '', label: 'Aguardando seleção do estado.' }];
    const cidades = Cidades.options[this.props.estado];
    return cidades ?? noState;
  }

  componentDidMount() {
    this.setState({ value: _.find(this.state.options, (o) => o.value === this.props.value) });
  }
